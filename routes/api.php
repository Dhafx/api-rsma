...
Route::middleware('api.key')->group(function () {
    ...
    //IGD
    Route::get('/kunjungan-igd', [KunjunganController::class, 'jumlahIgd']);
    Route::get('/kunjungan-igd/per-pj', [KunjunganController::class, 'jumlahIgdPerPj']);

    // Penyakit
    Route::get('/penyakit-ralan/top10-ralan', [PenyakitController::class, 'top10Ralan']);
    Route::get('/penyakit-ranap/top10-ranap', [PenyakitController::class, 'top10Ranap']);
